...
<head>
  ...
  <title>Seguimiento a Egresados <?php echo $__env->yieldContent('title'); ?></title>
  ...
  <div id="wrapper" >
    ...
    <ul class="navbar-nav sidebar sidebar-dark" style="background-color: #0B173B; font-size: 1.0em;" id="accordionSidebar" ><!-- Sidebar - Brand -->
      ...
      <li class="nav-item active">
        <a class="nav-link" href=<?php echo e(route('home_seguimiento_egresados')); ?>>
...
<?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/layouts/plantilla_seguimiento_egresados.blade.php ENDPATH**/ ?>