...
</br>                    <form method="POST" action="<?php echo e(route('agregar_fecha_taller')); ?>">
                        <?php echo csrf_field(); ?>
  <div class="form-row">
...
<?php echo $__env->make('layouts.plantilla_formacion_integral', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/personal_administrativo/formacion_integral/fecha_de_talleres.blade.php ENDPATH**/ ?>