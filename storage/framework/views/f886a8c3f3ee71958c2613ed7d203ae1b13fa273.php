...
<div class="form-row">
  <div class="form-group col-md-3">
      <label for="puesto" ><?php echo e(__('Puesto')); ?></label>
          <input id="puesto" maxlength="12" type="tel" class="form-control <?php if ($errors->has('puesto')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('puesto'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" onkeypress="return numeros (event)" name="puesto"  autocomplete="puesto" autofocus required>
...
<?php echo $__env->make('layouts.plantilla_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/personal_administrativo\admin_sistema/registro_cordinador.blade.php ENDPATH**/ ?>