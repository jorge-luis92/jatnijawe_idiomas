...
<div class="container" id="font7">
  <h2 style="font-size: 1.2em; color: #000000;" align="left"><strong>Datos del Estudiante</strong></h2>
                  <form method="POST" action="<?php echo e(route('enviar_solicitud_servicio')); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="carrera" value="<?php if(empty($carreras->carrera)){ $vacio=null; echo $vacio;} else{ echo $carreras->carrera;} ?>" required autocomplete="carrera">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="facultad" value="FACULTAD DE IDIOMAS" required autocomplete="facultad">
...
if (isset($messageCache)) { $message = $messageCache; }
  ...
  <div class="form-group col-md-3">
      <label for="avance" ><?php echo e(__('Porcentaje de Avance')); ?></label>
          <input id="avance" type="text" value="<?php if(empty($datos_practicas->porcentaje_avance)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->porcentaje_avance;} ?>" maxlength="2" placeholder="Ejemplo: 90 "onKeyUp="this.value = this.value.toUpperCase();" class="form-control <?php if ($errors->has('avance')) :
if (isset($message)) { $messageCache = $message; }
...
<div class="form-group col-md-12">
  <label for="institucion" ><?php echo e(__('Nombre del la Institución o Dependencia donde Realiza Servicio Social:')); ?></label>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="institucion" value="<?php if(empty($datos_practicas->nombre_dependencia)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->nombre_dependencia;} ?>" required autocomplete="institucion">
...
<label for="responsable" ><strong><?php echo e(__('Información del Titular de la Dependencia(A quien fue dirigido el oficio de Presentación)')); ?></strong></label>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="cargo_responsable" value="<?php if(empty($datos_practicas->cargo_titular)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->cargo_titular;} ?>" required autocomplete="cargo_responsable">
...
if (isset($messageCache)) { $message = $messageCache; }
      ...
      <div class="form-group col-md-4">
          <label for="fecha" ><?php echo e(__('Fecha de Realización de la carga de Datos')); ?></label>
