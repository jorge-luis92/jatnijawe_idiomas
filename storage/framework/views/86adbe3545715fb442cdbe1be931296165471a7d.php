      ...
      <tbody>
        ...
        <tr>
               ...
               <td><?php echo $estudiantes->nombre; ?> <?php echo $estudiantes->apellido_paterno; ?> <?php echo $estudiantes->apellido_materno; ?></td>
                ...
                <td style="text-align: center;"><a href="acreditar_egresado/<?php echo e($estudiantes->matricula); ?>">ACTIVAR</a></td>
             </tr>
...
<?php echo $__env->make('layouts.plantilla_auxadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/personal_administrativo\auxiliar_administrativo/futuros_egresados.blade.php ENDPATH**/ ?>