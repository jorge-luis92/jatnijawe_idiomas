        ...
        <tr>
               <th scope="row"><?php echo $estudiantes->matricula; ?></th>
                <th scope="row"><?php echo $estudiantes->semestre; ?></th>
                  <th scope="row"><?php echo $estudiantes->modalidad; ?></th>
               <td scope="row"><?php echo $estudiantes->nombre; ?> <?php echo $estudiantes->apellido_paterno; ?> <?php echo $estudiantes->apellido_materno; ?></td>
             </tr>
...
<?php echo $__env->make('layouts.plantilla_auxadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/personal_administrativo\auxiliar_administrativo/creados.blade.php ENDPATH**/ ?>