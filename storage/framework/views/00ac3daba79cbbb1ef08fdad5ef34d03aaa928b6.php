      ...
      <li class="nav-item" >
        ...
        <div id="datos_estudiante" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href=<?php echo e(route('busqueda_estudiante')); ?>>Busqueda</a>
        ...
        <div id="registar_tutores" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href=<?php echo e(route('registrar_tutor')); ?>>Registrar</a>
             <a class="collapse-item" href=<?php echo e(route('busqueda')); ?>>Tutores Registrados</a>
          </div>
        </div>
      </li>
...
<li class="nav-item" >
        ...
        <div id="registar_talleres" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header" style="color: blue">Opciones:</h6>
            <a class="collapse-item" href=<?php echo e(route('busqueda')); ?>>Agregar Taller</a>
             <a class="collapse-item" href=<?php echo e(route('busqueda')); ?>>Talleres Registrados</a>
              <a class="collapse-item" href=<?php echo e(route('busqueda')); ?>>Solicitudes</a>
              <a class="collapse-item" href=<?php echo e(route('busqueda')); ?>> Asignar Talleres</a>
                <a class="collapse-item" href=<?php echo e(route('busqueda')); ?>>Talleres Asignados</a>
          </div>
        </div>
      </li>
              ...
              <li class="nav-item">
               ...
               <img class="img-profile rounded-circle"  src="image/foto.png">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href=<?php echo e(route('cuenta_form')); ?>>
...
<?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/layouts/plantilla_formacion_integral.blade.php ENDPATH**/ ?>