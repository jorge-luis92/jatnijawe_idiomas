...
<li class="nav-item" >
      ...
      <li class="nav-item" >
              ...
              <div id="registar_talleritas" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  <h6 class="collapse-header" style="color: blue">Opciones:</h6>
                  <a class="collapse-item" href=<?php echo e(route('registro_tallerista')); ?>>Alta de Tallerista</a>
          ...
          <!--  <a class="collapse-item" href=<?php echo e(route('registro_extracurricular')); ?>>Agregar Actividad</a>-->
            <a class="collapse-item" href=<?php echo e(route('registro_taller')); ?>>Registrar Taller</a>
             ...
             <a class="collapse-item" href=<?php echo e(route('actividades_registradas')); ?>>Talleres Registrados</a>
              <a class="collapse-item" href=<?php echo e(route('conferencias_registradas')); ?>>Conferencias Registradas</a>
