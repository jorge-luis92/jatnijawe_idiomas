...
</br>  <form  method="post" action="<?php echo e(route('grupo_auxadm')); ?>">
                        <?php echo csrf_field(); ?>
<div class="form-row">
...
<table class="table table-bordered table-info" style="color: #000000;" >
    ...
    <td>  <a  href="<?php echo e(route ('datos_estudiantes')); ?>">VER DATOS</a></td>
    </tr>
...
<?php echo $__env->make('layouts.plantilla_auxadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/personal_administrativo\auxiliar_administrativo/grupo_auxadm.blade.php ENDPATH**/ ?>