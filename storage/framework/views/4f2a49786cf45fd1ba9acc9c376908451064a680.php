...
<input id="nombre" type="text" value="<?php if(empty($e->nombre)){ $vacio=null; echo $vacio;} else{ echo $e->nombre;} ?>" onKeyUp="this.value = this.value.toUpperCase()" class="form-control <?php if ($errors->has('nombre')) :
...
<label for="apellido_paterno" ><?php echo e(__('* Apellido Paterno')); ?></label>
     <input id="apellido_paterno" type="text"  value="<?php if(empty($e->apellido_paterno)){ $vacio=null; echo $vacio;} else{ echo $e->apellido_paterno;} ?>"onKeyUp="this.value = this.value.toUpperCase()" class="form-control <?php if ($errors->has('apellido_paterno')) :
if (isset($message)) { $messageCache = $message; }
...
<label for="apellido_materno" ><?php echo e(__('Apellido Materno')); ?></label>
     <input id="apellido_materno"  value="<?php if(empty($e->apellido_materno)){ $vacio=null; echo $vacio;} else{ echo $e->apellido_materno;} ?>" onKeyUp="this.value = this.value.toUpperCase()"  type="text" class="form-control <?php if ($errors->has('apellido_materno')) :
if (isset($message)) { $messageCache = $message; }
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-info" style="color: #000000;" >
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $eas->nombre_enfermedadalergia; ?></td>
              <td><?php echo $eas->tipo_enfermedadalergia; ?></td>
              <td><?php echo $eas->descripcion; ?></td>
              <td><?php echo $eas->indicaciones; ?></td>
            </tr>
...
<?php echo $__env->make('layouts.plantilla_estudiante', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/estudiante\datos/datos_medicos.blade.php ENDPATH**/ ?>