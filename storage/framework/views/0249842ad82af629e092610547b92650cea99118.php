...
<h2 style="font-size: 1.2em; color: #000000;" align="left"><strong>Datos del Estudiante</strong></h2>
                  <form method="POST" action="<?php echo e(route('enviar_solicitud_practicas')); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
  ...
  <div class="form-group col-md-1">
      ...
      <input id="grupo" type="tel" value="<?php if(empty($u->grupo)){ $vacio=null; echo $vacio;} else{ echo $u->grupo;} ?>" maxlength="2" class="form-control <?php if ($errors->has('grupo')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
  ...
  <div class="form-group col-md-5">
    ...
    <input id="carrera" type="text" disabled value="<?php if(empty($carreras->carrera)){ $vacio=null; echo $vacio;} else{ echo $carreras->carrera;} ?>"  onKeyUp="this.value = this.value.toUpperCase()"  class="form-control <?php if ($errors->has('carrera')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="curp" value="<?php if(empty($u->curp)){ $vacio=null; echo $vacio;} else{ echo $u->curp;} ?>" required autocomplete="curp">
...
<div class="form-group col-md-3">
    <label for="edad" ><?php echo e(__('* Edad')); ?></label>
        <input id="edad" type="tel"  value="<?php if(empty($u->edad)){ $vacio=null; echo $vacio;} else{ echo $u->edad;} ?>" disabled maxlength="2"  value="<?php echo e($u->edad); ?>" class="form-control <?php if ($errors->has('edad')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
  ...
  <div class="form-group col-md-4">
      <label for="fecha_ingreso" ><?php echo e(__(' Fecha de Ingreso')); ?></label>
            <input id="fecha_ingreso" disabled type="date"  value="<?php if(empty($u->fecha_ingreso)){ $vacio=null; echo $vacio;} else{ echo $u->fecha_ingreso;} ?>"  class="form-control" name="fecha_ingreso" required >
...
<div class="form-group col-md-12">
  <label for="institucion" ><?php echo e(__('Nombre del la Institución o Dependencia donde Realizará Prácticas Profesionales:')); ?></label>
    <input id="institucion" type="text" value="<?php if(empty($datos_practica->nombre_dependencia)){ $vacio=null; echo $vacio;} else{ echo $datos_practica->nombre_dependencia;} ?>"  onKeyUp="this.value = this.value.toUpperCase()" class="form-control <?php if ($errors->has('institucion')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('institucion'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="institucion" required autocomplete="institucion">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="nombre_titular" value="<?php if(empty($datos_practicas->nombre)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->nombre;} ?>"required autocomplete="nombre_titular">
...
<div class="form-group col-md-3">
   <label for="apellido_paterno" ><?php echo e(__('* Apellido Paterno')); ?></label>
         <input id="apellido_paterno_titular" type="text"  onKeyUp="this.value = this.value.toUpperCase()" class="form-control <?php if ($errors->has('apellido_paterno_titular')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('apellido_paterno_titular'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="apellido_paterno_titular" value="<?php if(empty($datos_practicas->apellido_paterno)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->apellido_paterno;} ?>"required autocomplete="apellido_paterno_titular">
...
<div class="form-group col-md-3">
   <label for="apellido_materno" ><?php echo e(__('Apellido Materno')); ?></label>
         <input id="apellido_materno_titular"  onKeyUp="this.value = this.value.toUpperCase()"  type="text" class="form-control <?php if ($errors->has('apellido_materno_titular')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('apellido_materno_titular'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="apellido_materno_titular" value="<?php if(empty($datos_practicas->apellido_materno)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->apellido_materno;} ?>" autocomplete="apellido_materno_titular">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="cargo_responsable" value="<?php if(empty($datos_practica->cargo_titular)){ $vacio=null; echo $vacio;} else{ echo $datos_practica->cargo_titular;} ?>" required autocomplete="cargo_responsable">
...
<div class="form-row">
  ...
  <div class="form-group col-md-2">
    ...
    <input type="text"  class="form-control" value="<?php if(empty($datos_practicas->num_exterior)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->num_exterior;} ?>"  id="numero_p" name="numero_p" placeholder="Número" onKeyUp="this.value = this.value.toUpperCase();" required>
  </div>
  <div class="form-group col-md-5">
  ...
  <div class="form-group col-md-3">
    ...
    <input type="text" class="form-control" id="codigo_postal" value="<?php if(empty($datos_practicas->cp)){ $vacio=null; echo $vacio;} else{ echo $datos_practicas->cp;} ?>"name="codigo_postal" placeholder="Código Postal" onKeyUp="this.value = this.value.toUpperCase();" required>
  </div>
  <div class="form-group col-md-5">
...
<div class="form-row">
  ...
  <input type="tel"  class="form-control" name="telefono" id="tel_celular" maxlength="10"  value="<?php if(empty($tel->numero)){ $vacio=null; echo $vacio;} else{ echo $tel->numero;} ?>"onkeypress="return numeros (event)"  placeholder="Formato a 10 digitos"  pattern="([0-9]{3})([0-9]{7})" required>
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
        <label for="fecha" ><?php echo e(__('Fecha de Realización de la Solicitud')); ?></label>
              <input id="fecha" type="date" value="<?php if(empty($datos_practica->fecha)){ echo date("Y-m-d");} else{ echo $datos_practica->fecha;}?>" disabled class="form-control <?php if ($errors->has('fecha')) :
if (isset($message)) { $messageCache = $message; }
