...
?>
    ...
    <tr>
      <td colspan="5">DIRECCI&Oacute;N:</td>
                     ...
                     <tr>
                      <td>  EMAIL</td>
                        <td ><input id="email"name="email" type="text" value="<?php echo e(Auth::user()->email); ?>"></td>
                        <td >FACEBOOK</td><td ><input name="face" type="text" required id="face"  value="<?php echo e(Auth::user()->email); ?>"/></td>
