...
<form  method="post" action="<?php echo e(route('reporte911_9A_6')); ?>">
                         <?php echo csrf_field(); ?>
<div class="form-row">
...
<a> Páginas</a>
    ...
    <a class="siguiente" align="rigth" href=<?php echo e(route('reporte911_9A_6')); ?>><strong>7</strong></a>
...
<?php echo $__env->make('layouts.plantilla_planeacion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/personal_administrativo\planeacion\reportes\reporte911_9A/reporte911_9A_6.blade.php ENDPATH**/ ?>