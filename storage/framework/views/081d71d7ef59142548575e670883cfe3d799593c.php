...
<body style="background:url(./image/logos_idiomas/logo_fon.png) center center no-repeat; text-align:justify;">
  ...
  <td>
	...
	A el/la C. <?php echo e($data->nombre); ?> <?php echo e($data->apellido_paterno); ?> <?php echo e($data->apellido_materno); ?>
  ...
  <td style="width:30%;text-align:center"><?php echo e($aca); ?>
  ...
  <td style="width:30%; text-align:center"><?php echo e($cul); ?>
  ...
  <td style="width:30%; text-align:center"><?php echo e($dep); ?>
  ...
  <td style="width:30%; text-align:center"><?php echo e($suma); ?>
...
<?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/personal_administrativo\formacion_integral/constanciaOficial.blade.php ENDPATH**/ ?>