    ...
    <ul class="navbar-nav sidebar sidebar-dark " style="background-color: #0A122A; font-size: 1.0em;" id="accordionSidebar" ><!-- Sidebar - Brand -->
      ...
      <li class="nav-item active">
        <a class="nav-link" href=<?php echo e(route('home_estudiante')); ?>>
          <img class="img-responsive center-block" src="<?php echo e(asset('logo.ico')); ?>" width="47" height="47" alt="">
...
<!--
      <li class="nav-item" >
        ...
        <div id="tutorias" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header" style="color: blue">Opciones:</h6>
            <a class="collapse-item" href=<?php echo e(route('tutorias')); ?>>Encuesta</a>
      ...
      <li class="nav-item">
        ...
        <div id="serv_social" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header" style="color: blue">Opciones:</h6>
          <!--  <a  class="collapse-item" href="#">Requisitos Previos</a>-->
            <a  class="collapse-item" href=<?php echo e(route('solicitud_servicioSocial')); ?>>Datos de Servicio Social</a>
           </div>
        </div>
      </li>
...
<div class="topbar-divider d-none d-sm-block"></div>
              ...
              <input type="text" id="sesion" hidden value="<?php echo e($id); ?>">
               <img class="img-profile rounded-circle"  src="<?php echo e(asset("/image/users/$im")); ?>" >
                ...
                <div class="dropdown-menu dropdown-menu-right animated--grow-in"  aria-labelledby="userDropdown">
                 <a class="dropdown-item" href=<?php echo e(route('cuenta')); ?> >
                  ...
                  <a class="dropdown-item" href=<?php echo e(route('foto_perfil')); ?> >
