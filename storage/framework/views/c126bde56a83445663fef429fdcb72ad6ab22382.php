  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="jornada">* Tipo de Sangre</label>
        <select name="comunidad" required d class="form-control">
...
<?php echo $__env->make('layouts.plantilla_estudiante', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jatnijawe\resources\views/estudiante\datos/datos_medicos.blade.php ENDPATH**/ ?>