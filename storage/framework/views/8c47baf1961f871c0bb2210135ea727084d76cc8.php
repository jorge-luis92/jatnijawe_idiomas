  ...
  <div class="row justify-content-center">
      <div class="col-md-8">
          <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo e(route('acreditar_extra')); ?>">
                <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
    ...
    <input type="text" name="id_extracurricular"  hidden class="form-control" value="<?php echo e($datos_taller->id_extracurricular); ?>">
...
<?php echo $__env->make('layouts.plantilla_formacion_integral', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\segunda_version\jatnijawe\resources\views/mails/notificacion_acreditacion.blade.php ENDPATH**/ ?>