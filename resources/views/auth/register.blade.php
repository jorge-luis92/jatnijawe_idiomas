                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" onkeypress="return numeros (event)" name="id" value="{{ old('name') }}" required autocomplete="id" autofocus>
