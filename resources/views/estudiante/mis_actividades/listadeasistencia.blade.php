...
<table align="left" style="font-size:15px" >
    <tr>
      ...
      <td><input type="text" value="{{$datos_extra->nombre_ec}}" /></td>
      <td colspan="3" style="font-size: 15px;">NOMBRE DE TUTOR</td>
      <td style="font-size: 10px;" ><input  type="text" required  value="{{$datos_extra->nombre}} {{$datos_extra->apellido_paterno}}{{$datos_extra->apellido_materno}}" /></td>
    </tr>
    <br/><br/><br/><br/>
    <tr>
      <td colspan="3" style="font-size: 15px;">FECHA INICIO</td>
      <td><input type="text"  value="{{ date('d-m-Y', strtotime($datos_extra->fecha_inicio)) }}" /></td>
      <td colspan="3" style="font-size: 15px;">FECHA FIN</td>
      <td><input  type="text"  value="{{ date('d-m-Y', strtotime($datos_extra->fecha_fin)) }}" /></td>
    </tr>
</table>
<table align="left" style="font-size:15px" >
      <tr>
      <td colspan="2" style="font-size: 15px;">HORA DE ENTRADA </td>
      <td ><input  type="text"  value="{{$datos_extra->hora_inicio}}" /></td>
      <td colspan="2" style="font-size: 15px;">HORA DE SALIDA</td>
      <td><input type="text" value="{{$datos_extra->hora_fin}}" /></td>
    </tr>
</table>
<br/><br/>
<div class="table">
