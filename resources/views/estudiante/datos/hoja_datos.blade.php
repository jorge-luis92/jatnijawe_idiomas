...
$d='image/users/'.$im?>
    <tr >
          ...
          <td><input name="semestre" type="text" required id="semestre" value="{{$data->semestre}}"  /></td>
          <td width="120" align="left">MATR&Iacute;CULA:
            <input name="matricula"  type="text" required id="matricula" value="{{$data->matricula}}"   /></td>
    </tr>
    <tr>
          <td>ESTATUS: </td>
          <td colspan="1"><input name="status"  type="text" required id="status" value="{{$data->estatus}}"  />
          </td>
    ...
    <tr>
      ...
      <td ><input name="nombre" type="text" required id="nombre" value="{{$data->nombre}}" /></td>
    </tr>
    <tr>
      <td colspan="2">APELLIDO PATERNO</td>
      <td ><input name="apepat" type="text" required id="apepat" value="{{$data->apellido_paterno}}" /></td>
      <td >APELLIDO MATERNO</td>
      <td ><input name="apemat" type="text" required id="apemat" value="{{$data->apellido_materno}}" /></td>
    </tr>
    <tr>
      <td colspan="2">FECHA DE NACIMIENTO (DD/MM/AA) </td>
      <td ><input name="fec_nac" type="text" required id="fec_nac" value="{{date('d-m-Y', strtotime($data->fecha_nacimiento))}}" /></td>
      <td >G&Eacute;NERO</td>
      <td ><input name="genero" type="text" required id="genero" value="{{$data->genero}}" /></td>
    </tr>
    <tr>
    <td colspan="5">DIRECCI&Oacute;N:</td>
                    ...
                    <tr>
                        <td colspan="5"><textarea name="direccion"  cols="94" rows="3" required id="direccion">{{$data->vialidad_principal}} #{{$data->num_exterior}}, C.P: {{$data->cp}} Colonia: {{$data->localidad}}, {{$data->municipio}}, {{$data->entidad_federativa}}.</textarea></td>
