...
: Búsqueda Estudiantes
 ...
 </br>                    <form  method="post" action="{{ route('busqueda_estudiante_fi') }}">
                         @csrf
                                                    ...
                                                    <table class="table table-bordered table-info" style="color: #000000;" >
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                               ...
                                                               <td>  <a data-toggle="modal" href="#">GENERAR COMPROBANTE</a></td>
                                                               <td>  <a data-toggle="modal" href="#">GENERAR CONSTANCIA</a></td>
                                                             </tr>
