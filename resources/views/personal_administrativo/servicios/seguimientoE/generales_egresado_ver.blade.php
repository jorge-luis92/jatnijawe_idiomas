...
<form method="POST" action="{{ route('generales_egresado_ver') }}">
                        @csrf
...
<div class="form-group col-md-3">
  ...
  <input name="genero" id="genero" required class="form-control"></input>
</div>
</div>
...
<div class="form-group col-md-2">
 <label for="lengua">Hablante de Lengua</label>
 <input name="lengua" id="lengua" required class="form-control"></input>
</div>

<div class="form-group col-md-5" id="labels">
<label for="nombre_lengua">Nombre de Lengua</label>
<input name="nombre_lengua" id="nombre_lengua" required class="form-control"></input>
</div>

<div class="form-group col-md-5">
<label for="tipo_lengua">Nivel de Comprensión </label>
<input name="tipo_lengua" id="tipo_lengua" required class="form-control"></input>
</div>
</div>
...
<div class="form-group col-md-2">
 <label for="lengua">Discapacitado</label>
 <input name="lengua" id="lengua" required class="form-control"></input>
</div>

<div class="form-group col-md-5" id="labels">
<label for="nombre_lengua">Tipo de discapacidad</label>
<input name="nombre_lengua" id="nombre_lengua" required class="form-control"></input>
</div>
...
<div class="form-row">
  <div class="form-group col-md-4">
    ...
    <input name="modalidad" id="modalidad" required class="form-control"></input>
</div>
